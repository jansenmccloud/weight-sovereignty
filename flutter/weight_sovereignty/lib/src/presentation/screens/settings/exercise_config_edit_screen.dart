    ...
    return ConfigFormScaffold(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          Text('Lifting:', style: Theme.of(context).textTheme.titleMedium?.copyWith(color: AppTheme.white)),
          const SizedBox(height: 12),
          TextField(
            controller: _weightController,
            style: TextStyle(color: AppTheme.white),
            decoration: const InputDecoration(labelText: 'Weight (kg)', labelStyle: TextStyle(color: AppTheme.white)),
          ...
          TextField(
            ...
            style: TextStyle(color: AppTheme.white),
            decoration: const InputDecoration(labelText: 'Reps', labelStyle: TextStyle(color: AppTheme.white)),
            keyboardType: TextInputType.number,
            inputFormatters: [digitsOnly],
          ),
          const SizedBox(height: 12),
          TextField(
            ...
            style: TextStyle(color: AppTheme.white),
            decoration: const InputDecoration(labelText: 'Sets', labelStyle: TextStyle(color: AppTheme.white)),
            keyboardType: TextInputType.number,
            inputFormatters: [digitsOnly],
          ),
          
          const SizedBox(height: 24),
          Text('Cardio:', style: Theme.of(context).textTheme.titleMedium?.copyWith(color: AppTheme.white)),
          const SizedBox(height: 12),
          TextField(
            controller: _distanceController,
            style: TextStyle(color: AppTheme.white),
            decoration: const InputDecoration(labelText: 'Distance (km)', labelStyle: TextStyle(color: AppTheme.white)),
          ...
          TextField(
            ...
            style: TextStyle(color: AppTheme.white),
            decoration: const InputDecoration(labelText: 'Duration (min)', labelStyle: TextStyle(color: AppTheme.white)),
            keyboardType: TextInputType.number,
            inputFormatters: [digitsOnly],
          ),
          const SizedBox(height: 12),
  ...
  Widget _enumDropdown<T>({required String label, required T value, required List<T> items, required String Function(T) labelOf, required ValueChanged<T?> onChanged}) {
    return Padding(
      ...
      child: DropdownButtonFormField<T>(
        initialValue: value,
        style: TextStyle(color: AppTheme.white),
        decoration: InputDecoration(labelText: label, labelStyle: TextStyle(color: AppTheme.white)),
