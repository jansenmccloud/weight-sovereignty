      ...
      child: Column(
        ...
        children: [
          ...
          TextField(
            ...
            decoration: const InputDecoration(labelText: 'Calories (kcal)', labelStyle: TextStyle(color: AppTheme.white)),
          ...
          TextField(
            ...
            decoration: const InputDecoration(labelText: 'Protein (g)', labelStyle: TextStyle(color: AppTheme.white)),
            keyboardType: TextInputType.number,
            inputFormatters: [digitsOnly],
          ),
          const SizedBox(height: 12),
          TextField(
            ...
            decoration: const InputDecoration(labelText: 'Carbs (g)', labelStyle: TextStyle(color: AppTheme.white)),
            keyboardType: TextInputType.number,
            inputFormatters: [digitsOnly],
          ),
          const SizedBox(height: 12),
          TextField(
            ...
            decoration: const InputDecoration(labelText: 'Fat (g)', labelStyle: TextStyle(color: AppTheme.white)),
            keyboardType: TextInputType.number,
            inputFormatters: [digitsOnly],
          ),
          const SizedBox(height: 12),
          TextField(
            ...
            decoration: const InputDecoration(labelText: 'Amount (g)', labelStyle: TextStyle(color: AppTheme.white)),
            keyboardType: TextInputType.number,
            inputFormatters: [digitsOnly],
          ),
        ],
