...
abstract final class AppTheme {
  ...
  static ThemeData dark() {
    final base = ColorScheme.fromSeed(seedColor: accent, brightness: Brightness.dark, surface: surface);
    return ThemeData(
      useMaterial3: true,
      brightness: Brightness.dark,
      scaffoldBackgroundColor: background,
      colorScheme: base.copyWith(surface: surface, primary: accent),
      appBarTheme: const AppBarTheme(backgroundColor: surface, foregroundColor: white, elevation: 0),
