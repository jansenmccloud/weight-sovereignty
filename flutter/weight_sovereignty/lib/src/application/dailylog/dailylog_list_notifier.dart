...
final dailyLogListProvider = AsyncNotifierProvider<DailyLogListNotifier, List<DailyLog>>(DailyLogListNotifier.new);

class DailyLogListNotifier extends AsyncNotifier<List<DailyLog>> with CrudListNotifierMixin<DailyLog> {
  @override
  ...
  Future<DailyLog?> getByCalendarDay(DateTime day) => _dailyLogRepo.getByCalendarDay(day);
}
